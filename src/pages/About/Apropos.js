    ...
    return (
        <div className='about'>
            ...
            <ul className='about-list'>
                ...
                <li className='about-list-item'>ADVP et la démarche éducative expérientielle en orientation - Décembre 2020 - Le patio formation</li>
            ...
            <p className="about-text">Je me suis ensuite reconvertie vers l’accompagnement professionnel et j''ai entrepris un parcours de formations pour devenir Consultante en bilan de compétences, métier que j’exerce depuis 2016. Toujours dans une optique de développement, et de perfectionnement, j’ai souhaité continuer de me former afin d’avoir un accompagnement le plus précis possible, axé sur le relationnel, le cognitif, la prise en compte des émotions, et non uniquement sur l’utilisation d’outils ou de supports pédagogiques. Je voulais aller plus loin dans les bilans avec les personnes.
            </p>
            <p className="about-text">C’est pourquoi je me suis lancé dans la formation de Praticien en thérapie brève stratégique et systémique, afin d’avoir une approche globale.
            </p>
            <h3 className='about-title-perso'>Et personnellement ? </h3>
            <p className="about-text">Au fur et à mesure de cette formation, des principes acquis, et des mises en pratique en bilan de compétences, j’ai ressenti l’envie d’aller plus loin, et de proposer d’autres types d’accompagnements plus axés sur la sphère personnelle.</p>
            <p className="about-text">Atteinte d’endométriose j’ai vécu les impacts de cette maladie, dans ma vie personnelle et professionnelle. C’est là que l’idée m’est venue, de dédier cette pratique aux femmes atteintes d’endométriose. C’est à ce moment que toute ma démarche a fait sens.</p>
            <p>C’est également un défi personnel, puisque cette maladie se transforme, pour moi, en une force et en quelque chose de plus positif.</p>
